...
* [change](https://github.com/sucremad/BeginnerExamples/blob/main/BeginnerExamples/Python/change_return_program.py) ---- _Change Return Program - The user enters a cost and then 			the amount of money given. The program will figure out the
&emsp;&emsp;&emsp;&emsp;&emsp; change and the number of quarters, dimes, nickels, pennies needed for the change_
